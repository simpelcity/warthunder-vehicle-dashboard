...
import { Container, Card, Image, Button, OverlayTrigger, Tooltip } from 'react-bootstrap'
...
import { FaArrowLeftLong, FaRegHeart, FaHeart, FaScaleBalanced } from 'react-icons/fa6'
  ...
  return (
    <>
      <Container className="p-4">
        <Button variant="primary" className="border-0 rounded-1 px-3 fs-5 d-inline-flex column-gap-1 mb-3 fw-semibold" href="/">
